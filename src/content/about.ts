  ...
  values: [
    {
      title: 'Compassion',
      description:
        'We treat every animal with kindness, empathy, and respect, recognizing their inherent worth and right to a life free from suffering.',
    },
    {
      title: 'Excellence',
      description:
        'We maintain the highest standards in animal care, from medical treatment to rehabilitation, ensuring every animal receives the best possible care.',
    },
    {
      title: 'Community',
      description:
        'We believe in the power of community action and work collaboratively with volunteers, donors, and partners to create lasting change.',
    },
    {
      title: 'Transparency',
      description:
        'We operate with complete transparency, ensuring our supporters know exactly how their contributions make a difference.',
    },
  ],
  team: {
    title: 'Our Team',
    description:
      'Our dedicated team of veterinarians, animal care specialists, and volunteers work tirelessly to ensure every animal receives the care they deserve.',
  },
};
