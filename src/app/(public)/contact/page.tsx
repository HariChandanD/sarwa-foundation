                ...
                >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <Label htmlFor="consent" className="text-sm text-gray-600">
                      I agree to be contacted by Sarwa Society for Animal
                      Welfare regarding my inquiry and understand that my
                      information will be handled according to the privacy
                      policy.
                    </Label>
                  </div>
